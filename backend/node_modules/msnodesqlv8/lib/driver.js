...
const driverModule = ((() => {
  const queueModule = require('msnodesqlv8/lib/queue').queueModule
  const { DriverRead } = require('msnodesqlv8/lib/reader')
  const { NativePreparedQueryHandler, NativeQueryHandler, NativeProcedureQueryHandler } = require('msnodesqlv8/lib/query-handler')
